...
<body>
  <!-- Create a form which will have text boxes for Note ID,
title,content and status along with a Send button. Handle errors like
empty fields -->
 ...
 <form action="saveNote" method="POST">
   ...
   <!-- display all existing notes in a tabular structure with
Id,Title,Content,Status, Created Date and Action -->
      <table>
      <h3>Updated details</h3>
          ...
          <thead>
           ...
           <td><form action="deleteNote" method="GET"><input
type="hidden" name="noteId" value="${note.noteId}"><input
